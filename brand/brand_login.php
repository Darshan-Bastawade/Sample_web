...
if(isset($_POST['btn_login']))
{
    ...
    $sql = "SELECT id,username,password FROM brands WHERE username='{$username}' AND password='{$pass}'";
    ...
    if(mysqli_num_rows($result)>0)
    {
        ...
        {
            session_start();
            $_SESSION["brand_id"]=$row['id'];
            $_SESSION["brand_username"]=$row['username'];
...
<body>
        <div class="container" style="margin-top:130px;">
            <div class="mb-3">
            <label  style="width:100%; margin-top:10px; text-align:left;border-radius: 5px;" class="btn btn-primary" >Brand Sign in</label>
            <form action="" method="post">
                ...
                <a button href="brand_register.php" class="btn btn-dark" style="margin-left:4vh;border-radius: 5px;" type="button">Create Account</a></button>
        </div>
        </div>
