...
if(isset($_POST['btn_register']))
{
   ...
   {
       $sql1="INSERT INTO users (name,username,password)VALUES('$name','$username','$pass')";
       if(mysqli_query($conn,$sql1)or die(mysqli_error($conn)))
       {
          header("Location:http://localhost/sample/creator_login.php");
...
<body>
        <div class="container" style="margin-top:130px;">
            <div class="mb-3">
            <label  style="width:100%; margin-top:10px; text-align:left;border-radius: 5px;" class="btn btn-primary" >Creator Sign up</label>
            <form action="" method="post">

                <input name="name" type="text" style="background:none; border:none;" class="form-control" id="name" placeholder="Name" required>
                ...
                <a button href="creator_login.php" class="btn btn-dark" style="margin-left:4vh;border-radius: 5px;margin-bottom: 30px;" type="button">Login here</a></button>
        </div>
        </div>
